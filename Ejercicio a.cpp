/*
*NOMBRE:Se ingresan los datos del competidor y luego se imprimen tods sus datos y la categoria en la cual competira.
*AUTOR:Alejandro Santibañez Sanchez
*FECHA:27/04/2017
*Resumen:Se ingresan los datos del competidor y luego se imprimen tods sus datos y la categoria en la cual competira.
*/
